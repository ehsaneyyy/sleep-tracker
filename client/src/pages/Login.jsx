...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0B0E14] p-4">
            ...
            >
                <h1 className="text-3xl font-light tracking-tight text-[#F1F5F9] mb-6 text-center">Welcome back</h1>
                ...
                <p className="text-sm text-[#94A3B8] text-center mt-6">
                    ...
                    <Link to="/signup" className="text-[#7B8CDE] hover:underline">Sign up</Link>
                </p>
            </form>
        </div>
    );
