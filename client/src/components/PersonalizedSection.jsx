...
export default function PersonalizedSection() {
    ...
    return (
        <div className="flex justify-center mt-16 sm:mt-20 relative z-20 px-4 mb-8">
            <div
                className={`w-full max-w-xl backdrop-blur-2xl rounded-3xl border ${borderColor} p-6 sm:p-8 md:p-10 bg-gradient-to-b ${gradient} shadow-2xl transition-all duration-700 animate-fade-in`}
            >
                <div className="text-center space-y-5 sm:space-y-6">
                    <div className="space-y-3">
                        <span className="text-4xl sm:text-5xl inline-block">
                            {mode === "sleep" ? "🌙" : "☀️"}
                        </span>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-light tracking-tight text-[#F1F5F9]">
                            {greeting}
                        </h2>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm font-medium text-[#94A3B8] transition-colors duration-500">
                    ...
                    <div className="pt-4">
                        <Link
                            to="/dashboard"
                            className="group inline-flex items-center gap-2 px-6 sm:px-8 py-3 rounded-full bg-[#7B8CDE] text-[#0B0E14] font-semibold hover:shadow-[0_0_25px_rgba(123,140,222,0.5)] hover:scale-105 transition-all duration-300"
                        >
