    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-[#0B0E14]/90 backdrop-blur-2xl border border-[#7B8CDE]/30 rounded-2xl p-6 shadow-[0_0_40px_rgba(123,140,222,0.2)] text-center">
                ...
                <h3 className="text-lg font-semibold text-[#F1F5F9] mb-2">Install SleepTracker</h3>
                <p className="text-sm text-[#94A3B8] mb-6">
                    Add it to your home screen for quick access and a full‑screen experience.
                </p>

                <button
                    onClick={handleInstall}
                    className="w-full py-3 bg-[#7B8CDE] text-[#0B0E14] rounded-full font-semibold hover:shadow-[0_0_20px_rgba(123,140,222,0.4)] hover:scale-105 transition-all duration-300"
                >
                    Add to Home Screen
                </button>
            </div>
